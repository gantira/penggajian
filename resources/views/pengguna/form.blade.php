...
<div class="form-group row">
    ...
    <div class="col-md-4">
        {!! Form::select('roles[]', ['admin'=>'admin', 'direktur'=>'direktur'],  isset($row) ? $row->roles->pluck('name','name') : null, ['class' => $errors->has('roles') ? 'form-control is-invalid' : $errors->has('roles') ? 'form-control is-invalid' : 'form-control', 'multiple']) !!}
        @if ($errors->has('roles'))
            <span class="invalid-feedback">
